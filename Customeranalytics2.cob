...
01 EMPLOYEE-RECORD.
   ...
   05 ANNUAL-SALARY-NUMERIC PIC 9(8).  *> Treat the entire salary as numeric
    ...
    PERFORM UNTIL EOF
        READ EMPLOYEE-FILE INTO EMPLOYEE-RECORD
            ...
            NOT AT END
                ...
                MOVE ANNUAL-SALARY-NUMERIC TO WS-ANNUAL-SALARY
                ...
                EVALUATE PERFORMANCE-RATING
                    ...
                    WHEN OTHER
                        MOVE 0 TO BONUS-RATE
                END-EVALUATE
                COMPUTE BONUS-AMOUNT = (WS-ANNUAL-SALARY / 100) * BONUS-RATE
