    ...
    PERFORM UNTIL EOF
        READ EMPLOYEE-FILE INTO EMPLOYEE-RECORD
            ...
            NOT AT END
                ...
                FUNCTION NUMVAL-C(ANNUAL-SALARY-STR) INTO WS-ANNUAL-SALARY-NUM
                DISPLAY "Annual Salary: " WS-ANNUAL-SALARY-NUM
                FUNCTION NUMVAL-C(PERFORMANCE-RATING-STR) INTO WS-PERFORMANCE-RATING-NUM
                ...
                EVALUATE WS-PERFORMANCE-RATING-NUM
                    ...
                    WHEN OTHER
                        MOVE 0 TO BONUS-RATE
                END-EVALUATE
                COMPUTE BONUS-AMOUNT = WS-ANNUAL-SALARY-NUM * BONUS-RATE
